...
| Description | Demo | Repository |
| ---------------------- | ------- | -------- |
| Project expanding and tweaking the Tour of Heroes official guide from the Angular website. | [Demo](https://sandorteleki.github.io/tour_of_heroes/) | [Repo](https://github.com/SandorTeleki/tour_of_heroes) |
<br />  
<br />  
